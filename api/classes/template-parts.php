...
class WPGo_Template_Parts {
	...
	public function single_portfolio_loop( $args = array() ) {

		if ( have_posts() ) while ( have_posts() ) : the_post();
			?>

			<article id="post-<?php the_ID(); ?>" <?php post_class( 'single-portfolio post singular-page' ); ?>>

				<header>
					<?php WPGo_Utility::hide_title_header_tag( get_the_ID(), "h1", "entry-title", "_wpgo_cpt_hide_title_header_tag" ); ?>
					<?php $this->single_cpt_meta( 'wpgo_portfolio_group', $args ); ?>
				</header>
				...
				<div class="post-content">
					...
					$image = WPGo_Utility::get_responsive_featured_image( get_the_id(), 'full', $image_attr );
	...
	public function single_slide_loop( $args = array() ) {
		...
		if ( have_posts() ) while ( have_posts() ) : the_post();
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'post singular-page' ); ?>>
				...
				<header>
					<?php WPGo_Utility::hide_title_header_tag( get_the_ID(), "h1", "entry-title", "_wpgo_cpt_hide_title_header_tag" ); ?>
					<?php $this->single_cpt_meta( 'wpgo_slideshow', $args ); ?>
				</header>
				...
				<div class="post-content">
					...
					$layout_num = (int) mb_substr( $wpgo_global_column_layout, 0, 1 );
					$arr = array( 'slider_content_full', 'slider_content_twothirds', 'slider_content_third' );
					$slider_thumb_size = $arr[$layout_num - 1];
					$image_attr = array( 'class' => 'featured-image post-image' );
					$image = WPGo_Utility::get_responsive_featured_image( get_the_id(), $slider_thumb_size, $image_attr );
	...
	public function single_testimonial_loop( $args = array() ) {
		...
		if ( have_posts() ) while ( have_posts() ) : the_post();
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'post singular-page' ); ?>>
				...
				<header>
					<?php WPGo_Utility::hide_title_header_tag( get_the_ID(), "h1", "entry-title", "_wpgo_cpt_hide_title_header_tag" ); ?>
					<?php $this->single_cpt_meta( 'wpgo_testimonial_group', $args ); ?>
				</header>
	...
	public function single_support_loop( $args = array() ) {
		...
		if ( have_posts() ) while ( have_posts() ) : the_post();
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'post singular-page' ); ?>>
				...
				<header>
					<?php WPGo_Utility::hide_title_header_tag( get_the_ID(), "h1", "entry-title", "_wpgo_cpt_hide_title_header_tag" ); ?>
					<?php $this->single_cpt_meta( 'wpgo_support_group', $args ); ?>
				</header>
	...
	public function portfolio_group_loop( $args = array() ) {
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
					...
					<header>
						...
						<?php WPGo_Utility::check_empty_post_title( $post_id ); ?>
							...
							<div class="post-meta">
								...
								<p<?php echo $header_align_meta; ?>>
									...
									<?php if ( $render_author ) : ?>
										<span class="author"><?php echo $author_prefix; ?><?php the_author_posts_link(); ?></span><?php echo $author_sep; ?><?php endif ?>
									<?php if ( $render_cats ) : ?>
										<span class="categories"><?php echo $cat_prefix; ?><?php echo get_the_term_list( get_the_ID(), 'wpgo_portfolio_group', '', ', ', '' ); ?></span><?php endif ?>
					...
					<div class="post-content">
						<?php if ( has_post_thumbnail() ) : ?>
							<div class="post-thumb">
								<?php
								echo WPGo_Utility::get_responsive_standard_featured_image( $post_id, 'post-thumbnail' ); /* Show post thumbnail image, if one exists. */
								?>
							</div> <!-- .post-thumb -->
						<?php endif; ?>
	...
	public function slideshow_group_loop( $args = array() ) {
							...
							<div class="post-meta">
								...
								<p<?php echo $header_align_meta; ?>>
									...
									<?php if ( $render_author ) : ?>
										<span class="author"><?php echo $author_prefix; ?><?php the_author_posts_link(); ?></span><?php echo $author_sep; ?><?php endif ?>
									<?php if ( $render_cats ) : ?>
										<span class="categories"><?php echo $cat_prefix; ?><?php echo get_the_term_list( get_the_ID(), 'wpgo_slideshow', '', ', ', '' ); ?></span><?php endif ?>
	...
	public function testimonial_group_loop( $args = array() ) {
							...
							<div class="post-meta">
								...
								<p<?php echo $header_align_meta; ?>>
									...
									<?php if ( $render_author ) : ?>
										<span class="author"><?php echo $author_prefix; ?><?php the_author_posts_link(); ?></span><?php echo $author_sep; ?><?php endif ?>
									<?php if ( $render_cats ) : ?>
										<span class="categories"><?php echo $cat_prefix; ?><?php echo get_the_term_list( get_the_ID(), 'wpgo_testimonial_group', '', ', ', '' ); ?></span><?php endif ?>
	...
	public function support_group_loop( $args = array() ) {
							...
							<div class="post-meta">
								...
								<p<?php echo $header_align_meta; ?>>
									...
									<?php if ( $render_author ) : ?>
										<span class="author"><?php echo $author_prefix; ?><?php the_author_posts_link(); ?></span><?php echo $author_sep; ?><?php endif ?>
									<?php if ( $render_cats ) : ?>
										<span class="categories"><?php echo $cat_prefix; ?><?php echo get_the_term_list( get_the_ID(), 'wpgo_support_group', '', ', ', '' ); ?></span><?php endif ?>
